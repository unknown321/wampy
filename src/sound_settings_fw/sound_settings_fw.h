...
class SoundSettingsFww {
  public:
    ...
    std::vector<std::pair<std::string, int>> eqtone = {{"Bass", 0}, {"Middle", 0}, {"Treble", 0}};
    std::vector<std::pair<std::string, int>> eqtoneFreq = {{"Bass", 2}, {"Middle", 2}, {"Treble", 2}};
    ...
    const std::string filterInvalid = "invalid filter";
