...
release: release-clean build-arm server nw-installer/installer/userdata.tar.gz nw-installer/installer/userdata.uninstaller.tar.gz
	...
	$(MAKE) -C nw-installer OUTFILE=$(PRODUCT).uninstaller.exe APPNAME=$(PRODUCT)-uninstaller A30=0 WM1A=0 WM1Z=0 ZX300=0 DMPZ1=0 USERDATA_FILENAME=userdata.uninstaller.tar.gz build
	...
	$(MAKE) -C nw-installer OUTFILE=$(PRODUCT).exe APPNAME=$(PRODUCT) A30=0 WM1A=0 WM1Z=0 ZX300=0 DMPZ1=0 build
	# next, build Windows installer (with uninstaller included)
	$(MAKE) -C nw-installer OUTFILE=$(PRODUCT).exe APPNAME=$(PRODUCT) A30=0 A40MOD_ONLY=1 WM1A=0 WM1Z=0 ZX300=0 DMPZ1=0 win
